...
const LocationMap: FC = () => {
  return (
    <section className="p-4">
      <h2 className="text-black text-2xl font-bold">Наше местоположение</h2>
      ...
      <address className="mt-4">
        <ul>
          <li>
            <span className="text-slate-700">Самарская обл., 443100</span>
          </li>
          <li>
            <span className="text-slate-700">Самара, пр-т. Ленина, 2А</span>
          </li>
          <li className="mt-3 text-xl flex items-center">
            <Image
              alt="Номер телефона"
              src={phoneIcon}
              width={30}
            ...
            />
            <Link
              className="text-green-900 text-xl font-bold ml-2"
